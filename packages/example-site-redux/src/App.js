...
class App extends ReactHabitat.Bootstrapper {
	...
	constructor() {
		...
		containerBuilder.registerAsync(() => import('./containers/AlbumCollection')).as('RAlbumCollection');
		containerBuilder.registerAsync(() => import('./containers/AddAlbumForm')).as('RAddAlbumForm');
